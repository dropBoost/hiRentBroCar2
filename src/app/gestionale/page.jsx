...
export default function Gestionale () {
    return (
        ...
        <div className="grid grid-cols-12 grid-rows-12 h-screen w-screen md:p-5 p-0 justify-center items-center">
          ...
          <div className="md:col-span-11 col-span-12 md:row-span-11 row-span-11 md:col-start-2 col-start-1 md:row-start-2 row-start-3 h-full bg-neutral-900"><HomeGestionale/></div>
        </div>
        </>
    )
}